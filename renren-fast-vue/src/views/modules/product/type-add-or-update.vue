  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="类型编号" prop="typeCode">
        <el-input v-model="dataForm.typeCode" placeholder="请输入数字编号"></el-input>
      </el-form-item>
      <el-form-item label="类型名称" prop="typeName">
        <el-input v-model="dataForm.typeName" placeholder="请输入类型名称"></el-input>
      </el-form-item>
    </el-form>
        ...
        if (valid) {
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              this.$message.error(data.msg + '，请修改类型编号')
            }
          })
        }
      })
